...
with project_client:
    agent = project_client.agents.create_agent(
        ...
        name="my-assistant",
        instructions="You are a helpful assistant, answer questions base on knowledge from the Azure AI Search index.",
    ...
    message = project_client.agents.create_message(
        thread_id=thread.id,
        role="user",
        # content="按知识库的内容回答, 支持加密吗?",
        content="按知识库的内容回答, ai 代理是否有其他收费?",
    )
